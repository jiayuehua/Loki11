...
////////////////////////////////////////////////////////////////////////////////
struct NewCreatePolicy
{
  template<class T, class... Arg>
  static T *CreateObject(Arg &&...arg)
  {
    return new T(std::forward<T>(arg)...);
  }
};

template<unsigned int L, class CreatePolicy, class T, class... Arg>
class OrderedStatic : public Private::OrderedStaticBase<T>
{
public:
  OrderedStatic(Arg &&...arg) : Private::OrderedStaticBase<T>(L), args_(std::forward<Arg>...)
  {
    OrderedStaticManager::Instance().registerObject(L, this, &Private::OrderedStaticCreatorFunc::createObject);
  }

  void createObject()
  {
    Private::OrderedStaticBase<T>::SetLongevity(std::apply(NewCreatePolicy::template CreateObject<T>, args_));
  }
