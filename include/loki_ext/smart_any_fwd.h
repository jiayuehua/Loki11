...
//
//  Classes:    unique_any, scoped_any and shared_any
//
//  Functions:  get
//              reset
//              release
...
T get(unique_any<T, close_policy, invalid_value, unique> const &t);

// return true if the unique_any contains a currently valid resource
template<typename T, class close_policy, class invalid_value, int unique>
bool valid(unique_any<T, close_policy, invalid_value, unique> const &t);

// return wrapped resource and give up ownership
template<typename T, class close_policy, class invalid_value, int unique>
T release(unique_any<T, close_policy, invalid_value, unique> &t);

// destroy designated object
template<typename T, class close_policy, class invalid_value, int unique>
void reset(unique_any<T, close_policy, invalid_value, unique> &t);
...
void reset(unique_any<T, close_policy, invalid_value, unique> &t, U newT);
...
//template<typename T,class close_policy,class invalid_value,int unique>
//T* address( unique_any<T,close_policy,invalid_value,unique> & t );
...
// use that information to make unique_any safer by disallowing actions like
// dereferencing a handle or calling delete on a handle.
template<typename T>
struct has_unused
{
private:
  template<class U, int U::*>
  struct wrap_t;
  template<typename U>
  static yes_t check(wrap_t<U, &U::unused> *);
  template<typename U>
  static no_t __cdecl check(...);
