...
/// a template.
template<typename>
struct Forbidden_conversion;// This struct must not be defined!
...
public:
  ...
  {
    static_assert(i <= (8 * sizeof(word_t)), "Index_is_beyond_size_of_data");
    static_assert(sizeof(SafeBitConst) == sizeof(word_t), "Object_size_does_not_match_data_size");
