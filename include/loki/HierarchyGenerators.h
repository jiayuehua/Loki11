...
template<
  ...
  class Unit,
  class Root>
class GenLinearHierarchy<mp::mp_list<T1, T2...>, Unit, Root>
  : public Unit<T1, GenLinearHierarchy<mp::mp_list<T2...>, Unit, Root>>
{
};
...
template<
  ...
  class Unit,
  class Root>
class GenLinearHierarchy<mp::mp_list<T>, Unit, Root>
  : public Unit<T, Root>
{
};
